        ...
        public void start(Stage primaryStage) throws Exception {
            ...
            openReferenceWindowBtn.setOnAction(referenceWindowOpenEvent -> {
                ...
                archiveConfirmBtn.setOnAction(confirmEvent -> {
                    controller.getAddIdToReferenceTable(docID);
                    String shed = " Shed: " + shedTextField.getText() + "\n";
                    String rack = "Rack: " + rackTextField.getText() + "\n";
                    String folder = "Folder: " + folderTextField.getText() + "\n";
            ...
            addDocumentBtn.setOnAction(c -> {
                ...
                try {
                    ...
                    errorDialog.setHeaderText(null);
                    errorDialog.setContentText("Non Integer Values are not valid " + "\n" + "Please select another ID!");
                    errorDialog.showAndWait();
